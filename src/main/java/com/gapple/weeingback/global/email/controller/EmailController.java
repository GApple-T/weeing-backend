...
import com.gapple.weeingback.global.email.dto.EmailPostDto;
import com.gapple.weeingback.global.email.dto.EmailResponseDto;
...
public class EmailController {
    ...
    public ResponseEntity sendPasswordMail(@RequestBody EmailPostDto emailPostDto) {
        EmailContent emailMessage = EmailContent.builder()
